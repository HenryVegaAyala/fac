    ...
    if (isset($_POST['btnGenerarReporte'])) {
        ...
        if ($ddlTipoReporte === '10') {
            ...
            for ($i = 0; $i < $countRsGastoResumen; $i++) {
                ...
                // $strfilas__gasto .= "<tr><td>" . $rsGastoDetallado[$i]['tipogasto'] . " " . $rsGastoDetallado[$i]['importe'] . "</td></tr>";
                ...
                if ($countRsGastoDetallado > 0) {
                    ...
                    for ($j = 0; $j < $countRsGastoDetallado; $j++) {
                        ...
                        // $strfilas__gasto .= "<tr><td>" . $rsGastoDetallado[$j]['desctipogasto'] . " " . $rsGastoDetallado[$j]['importe'] . "</td></tr>";
                    }
                }
